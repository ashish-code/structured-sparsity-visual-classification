function calcL1ClassPerf(dataSet)
...
coeffPerfFileAvg  = strcat(rootDir,dataSet,coeffPerfDir,algo,num2str(param),method,'.l1');
...
for iCategory = 1 : nCategory
    ...
    for iter = 1 : nListTrainPos
        ...
        coeffFilePathAvg = strcat(rootDir,dataSet,coeffDir,imageName,num2str(dictSize),dictType,algo,num2str(param),method,'.l1');
        try
