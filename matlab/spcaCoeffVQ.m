% spcaCoffVQ : calcSSPCACoeffVQ
function spcaCoeffVQ(dataSet)
dictType = 'universal';
dictSize = 1000;
algo = 'spca';
param = '';
...
for iCategory = 1 : nCategory
    ...
    dictDataFile = strcat(rootDir,dataSet,dictDir,dataSet,dictType,num2str(dictSize),algo,'.dict');
    ...
    for iListSize = 1 : nListSizes
        ...
        for iter = 1 : nListTrainPos
            ...
            callVQEnc(imageName,dict,dataSet,dictType,dictSize,algo,param);            
        end
...
function callVQEnc(imageName,dict,dataSet,dictType,dictSize,algo,param)
rootDir = '/vol/vssp/diplecs/ash/Data/';
coeffDir = '/Coeff/';
dsiftDir = '/DSIFT/';
...
coeffFilePathAvg = [(rootDir),(dataSet),(coeffDir),imageName,(dictType),(algo),num2str(param),(method),'.avg'];
