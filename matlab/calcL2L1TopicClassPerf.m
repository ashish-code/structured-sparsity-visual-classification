% calculate group lasso with L2L1 mixed-norm sparsity regularization
function calcL2L1TopicClassPerf(dataSet,colClust,ccType)
...
coeffPerfFileAvg  = strcat(rootDir,dataSet,coeffPerfDir,algo,num2str(param),method,ccType,num2str(colClust),'.l1l2');
...
for iCategory = 1 : nCategory
    ...
    for iter = 1 : nListTrainPos
        ...
        coeffFilePathAvg = [(rootDir),(dataSet),(coeffDir),(imageName),num2str(dictSize),(dictType),algo,num2str(param),(method),ccType,num2str(colClust),'.l1l2'];
        try
