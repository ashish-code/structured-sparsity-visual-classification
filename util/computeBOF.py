...
Input arguments: [1] dataset, one of ['Caltech101','Caltech256','Scene15','VOC2006','VOC2007','VOC2010']
optional input arguments:
[2] nCodewords, default = 1000
[3] nSamples, default = 500000
'''
...
def main():
    ...
    [CodeBook,label] = kmeans2(cumData,nCodewords,iter=nIterKmeans,minit='points',missing='warn') #@UnusedVariable
    # write codebook to file
    cbfilepath = rootPath+dataset+cbDir+dataset+str(nCodewords)+codebookext
    ...
    for cat in catlist:
        ...
        catboffilepath = rootPath+dataset+bofDir+catname+str(nCodewords)+bofext
